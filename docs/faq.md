...
- [Why `ignore_changes` is removed from the Managed Node Group lifecycle?](https://github.com/pinterest/terraform-aws-eks/blob/pinterest-release-20.20.0/docs/faq.md#why-ignore-changes-is-removed-from-the-managed-node-group-lifecycle)
...
Reference to the original docs regarding this change: [Why are there no changes when a node group's desired_size is modified?](https://github.com/terraform-aws-modules/terraform-aws-eks/blob/v20.20.0/docs/faq.md#why-are-there-no-changes-when-a-node-groups-desired_size-is-modified)
